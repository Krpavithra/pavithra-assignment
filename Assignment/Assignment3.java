...
public class Assignment3 {
	...
	driver.findElement(By.id("createLeadForm_description")).sendKeys("Please enter ur description");
	driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("krpavi6@gmail.com");
    ...
    driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("PAVIKR");
    driver.findElement(By.className("smallSubmit")).click();
